...
namespace poutre
{
  ...
  public:
    ...
    POUTRE_CXX14_CONSTEXPR explicit
    static_array_base (value_type a) POUTRE_NOEXCEPT
    {
    ...
    POUTRE_CXX14_CONSTEXPR explicit
    static_array_base (value_type a0, value_type a1) POUTRE_NOEXCEPT
    {
    ...
    POUTRE_CXX14_CONSTEXPR explicit
    static_array_base (value_type a0, value_type a1, value_type a2) POUTRE_NOEXCEPT
    {
    ...
    POUTRE_CXX14_CONSTEXPR explicit
    static_array_base (value_type a0, value_type a1, value_type a2, value_type a3) POUTRE_NOEXCEPT
    {
    ...
    POUTRE_CXX14_CONSTEXPR explicit
    static_array_base (const value_type (&rhs)[Rank]) POUTRE_NOEXCEPT
    {
    ...
    void
    assign (const valuetype& value) POUTRE_NOEXCEPT
    {
    ...
    void
    fill (const valuetype& value) POUTRE_NOEXCEPT
    {
      details::helper_assign_container_valueop<self_type, AssignOpType::AssignOp, Rank>::op (value, *this);
    }
    ...
    void
    swap (self_type& rhs) POUTRE_NOEXCEPT
    {
    ...
    POUTRE_ALWAYS_INLINE POUTRE_CXX14_CONSTEXPR pointer
    data () POUTRE_NOEXCEPT
    {
      return m_array;
    }
  ...
  template <typename value_type, ptrdiff_t size, typename ArithmeticType, typename std::enable_if<std::is_arithmetic<ArithmeticType>::value>::type* = nullptr>
  ...
  POUTRE_CXX14_CONSTEXPR void
  swap (static_array_base<value_type, size>& lhs, static_array_base<value_type, size>& rhs) POUTRE_NOEXCEPT //POUTRE_NOEXCEPT_IF(lhs.swap(rhs))
  {
    (lhs.swap (rhs));
  }
