...
namespace poutre
{
  ...
  template<size_t dims>
  void
  ImageToStringDenseCompoundType_3PlanesDispatchPType(const poutre::IInterface &img, PType ptype, std::ostringstream &ostrm)
  {
    switch( ptype )
    {
    case PType::PType_GrayUINT8:
  ...
  template<size_t dims>
  void
  ImageToStringDenseCompoundType_4PlanesDispatchPType(const poutre::IInterface &img, PType ptype, std::ostringstream &ostrm)
  {
    switch( ptype )
    {
    case PType::PType_GrayUINT8:
