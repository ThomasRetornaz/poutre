...
namespace poutre
{
  ...
  std::unique_ptr<IInterface> LoadFromOIIO(const std::string &image_path)
  {
    ...
    if( spec.depth > 1 )
      POUTRE_RUNTIME_ERROR(poutre::format("LoadFromOIIO: nD with n >2  format require hdf5 ext, use LoadFromHDF5"));
    ...
    {
    case OpenImageIO_v2_2::TypeDesc::BASETYPE::UINT8: ptype = PType::PType_GrayUINT8; break;
    case OpenImageIO_v2_2::TypeDesc::BASETYPE::INT32: ptype = PType::PType_GrayINT32; break;
    case OpenImageIO_v2_2::TypeDesc::BASETYPE::FLOAT: ptype = PType::PType_F32; break;
    case OpenImageIO_v2_2::TypeDesc::BASETYPE::INT64: ptype = PType::PType_GrayINT64; break;
    case OpenImageIO_v2_2::TypeDesc::BASETYPE::DOUBLE: ptype = PType::PType_D64; break;
    default:
      std::ostringstream errorstream;
      errorstream << " load_image(): Error reading image '";
      errorstream << image_path;
