...
namespace poutre
{
  ...
  std::ostream &operator<<(std::ostream &os, CompOpType compOpType)
  {
    switch( compOpType )
    {
    case CompOpType::CompOpDiff: os << "!="; break;
    case CompOpType::CompOpEqual: os << "=="; break;
    case CompOpType::CompOpInf: os << "<"; break;
    case CompOpType::CompOpInfEqual: os << "<="; break;
    case CompOpType::CompOpSup: os << ">"; break;
    case CompOpType::CompOpSupEqual: os << ">="; break;
  ...
  std::ostream &operator<<(std::ostream &os, ArithOpType arithOpType)
  {
    switch( arithOpType )
    {
    case ArithOpType::ArithOpPlus: os << "+"; break;
    case ArithOpType::ArithOpMinus: os << "-"; break;
    case ArithOpType::ArithOpMul: os << "*"; break;
    case ArithOpType::ArithOpDiv: os << "/"; break;
    case ArithOpType::ArithOpMod: os << "%"; break;
    default: //  ArithOpType::;
  ...
  std::ostream &operator<<(std::ostream &os, AssignOpType assignOpType)
  {
    switch( assignOpType )
    {
    case AssignOpType::AssignOpAdd: os << "+="; break;
    case AssignOpType::AssignOpMinus: os << "-="; break;
    case AssignOpType::AssignOpMul: os << "*="; break;
    case AssignOpType::AssignOpDiv: os << "/="; break;
    case AssignOpType::AssignOpMod: os << "%="; break;
    case AssignOpType::AssignOp: os << "="; break;
