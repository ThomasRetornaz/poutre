...
namespace poutre
  ...
  //http://www.boost.org/doc/libs/1_57_0/libs/log/doc/html/log/detailed/sources.html
  ...
  ////global_logger, boost::log::sources::severity_logger_mt<boost::log::trivial::severity_level>)
  //  {
