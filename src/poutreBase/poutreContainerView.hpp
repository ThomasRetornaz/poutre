 ...
 using cstrided_array_view = strided_array_view<const T, Rank>;*/
  ...
  template<class T, ptrdiff_t Rank> class array_view
  {
    ...
    template<typename U,
             ptrdiff_t R = Rank,
             typename    = std::enable_if_t<R == 1 &&
                                         // std::is_convertible<std::add_pointer_t<U>,
                                         // pointer>::value && std::is_same<std::remove_cv_t<U>,
    ...
    template<class U                                                                                            = T,
             typename std::enable_if<std::is_convertible<typename std::add_pointer<U>::type, pointer>::value
  ...
  template<class T, ptrdiff_t Rank> class strided_array_view
  {
    ...
    POUTRE_CONSTEXPR index_type stride() const POUTRE_NOEXCEPT { return m_stride_idx; }
    /**@}*/
