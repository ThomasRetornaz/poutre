...
const POUTRE_CXX14_CONSTEXPR int SIMD_IDEAL_MAX_ALIGN_BYTES = XSIMD_DEFAULT_ALIGNMENT;

#if XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX512_VERSION
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT8_SIZE   = 64;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT16_SIZE  = 32;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT32_SIZE  = 16;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT64_SIZE  = 8;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_FLOAT_SIZE  = 16;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_DOUBLE_SIZE = 8;
#elif XSIMD_X86_INSTR_SET >= XSIMD_X86_AVX_VERSION
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT8_SIZE   = 32;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT16_SIZE  = 16;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT32_SIZE  = 8;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT64_SIZE  = 4;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_FLOAT_SIZE  = 8;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_DOUBLE_SIZE = 4;
#elif XSIMD_X86_INSTR_SET >= XSIMD_X86_SSE2_VERSION
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT8_SIZE   = 16;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT16_SIZE  = 8;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT32_SIZE  = 4;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_INT64_SIZE  = 2;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_FLOAT_SIZE  = 4;
const POUTRE_CXX14_CONSTEXPR int SIMD_BATCH_DOUBLE_SIZE = 2;
