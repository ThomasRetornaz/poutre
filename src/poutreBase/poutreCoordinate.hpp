...
class bounds
    : public static_array_base<ptrdiff_t, Rank> // TODO restrain alignement
                                                // capabilities if any
{
public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
...
public:
  ...
  POUTRE_CXX14_CONSTEXPR bounds()
      POUTRE_NOEXCEPT_IF(POUTRE_NOEXCEPT_EXPR(parent()))
      : parent() {
    details::helper_assign_container_valueop<self_type, AssignOpType::AssignOp,
                                             Rank>::op(0, *this);
  }

  POUTRE_CONSTEXPR explicit bounds(value_type a)
      POUTRE_NOEXCEPT_IF(POUTRE_NOEXCEPT_EXPR(parent(a)))
      : parent(a) {}
  ...
  POUTRE_CONSTEXPR bounds(const parent &rhs)
      POUTRE_NOEXCEPT_IF(POUTRE_NOEXCEPT_EXPR(parent(rhs)))
      : parent(rhs) {}
  ...
  POUTRE_CXX14_CONSTEXPR bounds &
  operator+=(const index<rank> &rhs) POUTRE_NOEXCEPT {
    details::helper_assign_container_op<self_type, AssignOpType::AssignOpAdd,
                                        Rank>::op(rhs, *this);
    return *this;
  }
  ...
  POUTRE_CXX14_CONSTEXPR bounds &
  operator-=(const index<rank> &rhs) POUTRE_NOEXCEPT {
    details::helper_assign_container_op<self_type, AssignOpType::AssignOpMinus,
                                        Rank>::op(rhs,
  ...
  POUTRE_CXX14_CONSTEXPR bounds &
  operator+=(const value_type &rhs) POUTRE_NOEXCEPT {
    details::helper_assign_container_valueop<
        self_type, AssignOpType::AssignOpAdd, Rank>::op(rhs, *this);
    return *this;
  }
  ...
  operator-=(const value_type &rhs) POUTRE_NOEXCEPT {
    details::helper_assign_container_valueop<
        self_type, AssignOpType::AssignOpMinus,
        Rank>::op(rhs, *this); //*this is the result operation *this-=rhs
    return *this;
  }
  ...
  POUTRE_CXX14_CONSTEXPR bool
  contains(const index<rank> &idx) const POUTRE_NOEXCEPT {
    return details::helper_contains_container_op<bounds<rank>, index<rank>,
                                                 Rank>::op(*this, idx);
  }
...
template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR bool
operator==(const bounds<Rank> &lhs, const bounds<Rank> &rhs) POUTRE_NOEXCEPT {
...
template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR bounds<Rank> operator*(const bounds<Rank> &rhs,
                                              ptrdiff_t v)POUTRE_NOEXCEPT {
  return rhs * v;
}

template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR bounds<Rank>
operator*(ptrdiff_t v, const bounds<Rank> &rhs)POUTRE_NOEXCEPT {
  return rhs * v;
}
...
public:
  ...
  POUTRE_CONSTEXPR explicit index(value_type a)
      POUTRE_NOEXCEPT_IF(POUTRE_NOEXCEPT_EXPR(parent(a)))
      : parent(a) {}
  ...
  POUTRE_CONSTEXPR index(const parent &rhs)
      POUTRE_NOEXCEPT_IF(POUTRE_NOEXCEPT_EXPR(parent(rhs)))
      : parent(rhs) {}
   ...
   */
  POUTRE_CXX14_CONSTEXPR self_type
  operator+(const self_type &rhs) const POUTRE_NOEXCEPT {
    self_type tmp(*this); // return a fresh new object
    details::helper_assign_container_op<self_type, AssignOpType::AssignOpAdd,
                                        Rank>::op(rhs, tmp);
    return tmp;
  ...
  POUTRE_CXX14_CONSTEXPR self_type &
  operator+=(const self_type &rhs) POUTRE_NOEXCEPT {
    details::helper_assign_container_op<self_type, AssignOpType::AssignOpAdd,
                                        Rank>::op(rhs, *this);
    return *this;
  }
  ...
  template <ptrdiff_t R = Rank,
            typename std::enable_if<R == 1, void>::type * = nullptr>
  ...
  POUTRE_CXX14_CONSTEXPR self_type operator-() const POUTRE_NOEXCEPT {
    ...
    details::helper_assign_container_op<self_type, AssignOpType::AssignOpNegate,
                                        Rank>::op(tmp, tmp);
    return tmp;
  }
  ...
  operator-=(const value_type &rhs) POUTRE_NOEXCEPT {
    details::helper_assign_container_valueop<
        self_type, AssignOpType::AssignOpMinus, Rank>::op(rhs, *this);
    return *this;
  }

  POUTRE_CXX14_CONSTEXPR bool
  operator<(const self_type &rhs) const POUTRE_NOEXCEPT {
    return details::helper_comp_lexicographic_less_container_op<self_type>::op(
        *this, rhs);
  }

  POUTRE_CXX14_CONSTEXPR bool
  operator<=(const self_type &rhs) const POUTRE_NOEXCEPT {
    return !details::helper_comp_lexicographic_sup_container_op<self_type>::op(
        *this, rhs);
  }
...
//! index equality
template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR bool operator==(const index<Rank> &rhs,
                                       const index<Rank> &lhs) POUTRE_NOEXCEPT {
  return lhs.operator==(rhs);
}
template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR bool operator!=(const index<Rank> &rhs,
...
//! index arithmetic
template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR index<Rank>
operator+(const index<Rank> &rhs, const index<Rank> &lhs) POUTRE_NOEXCEPT {
  return (rhs + lhs);
}
...
template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR index<Rank> operator*(const index<Rank> &rhs,
                                             ptrdiff_t v)POUTRE_NOEXCEPT {
  return (rhs * v);
}
...
template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR index<Rank>
operator*(ptrdiff_t v, const index<Rank> &rhs)POUTRE_NOEXCEPT {
  return (rhs * v);
}
...
template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR bounds<Rank>
operator+(const index<Rank> &lhs, const bounds<Rank> &rhs) POUTRE_NOEXCEPT {
  return (rhs + lhs);
}

template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR bounds<Rank> operator+(const bounds<Rank> &rhs,
                                              const index<Rank> &lhs) {
  bounds<Rank> tmp(rhs); // return a fresh new object
  details::helper_assign_container_op<bounds<Rank>, AssignOpType::AssignOpAdd,
                                      Rank>::op(lhs, tmp);
  return tmp;
}
template <ptrdiff_t Rank>
POUTRE_CXX14_CONSTEXPR bounds<Rank> operator-(const bounds<Rank> &rhs,
                                              const index<Rank> &lhs) {
  bounds<Rank> tmp(rhs); // return a fresh new object
  details::helper_assign_container_op<bounds<Rank>, AssignOpType::AssignOpMinus,
                                      Rank>::op(lhs, tmp);
  return tmp;
}
...
class bounds_iterator
    : public std::iterator<strided_iterator_tag, index<Rank>, ptrdiff_t,
...
public:
  using parent = std::iterator<strided_iterator_tag, index<Rank>, ptrdiff_t,
                               const index<Rank>, const index<Rank>>;
...
public:
  bounds_iterator(const bounds<Rank> &bnd,
                  const index<Rank> &curr = index<Rank>{}) POUTRE_NOEXCEPT
      : m_bnd(bnd),
        m_idx(curr),
        m_idxend(m_bnd) {
  ...
  bounds_iterator &operator+=(difference_type n) POUTRE_NOEXCEPTONLYNDEBUG {
    poutre::details::shift_op<bounds<Rank>, index<Rank>>::op(m_bnd, m_idx, n,
                                                             m_idx);
  ...
  difference_type
  operator-(const bounds_iterator &rhs) const POUTRE_NOEXCEPTONLYNDEBUG {
    return details::get_offset_from_coord_nostride<bounds<Rank>,
                                                   index<Rank>>::op(m_bnd,
                                                                    m_idx) -
           details::get_offset_from_coord_nostride<bounds<Rank>,
                                                   index<Rank>>::op(rhs.m_bnd,
                                                                    rhs.m_idx);
  }
...
template <ptrdiff_t Rank>
bounds_iterator<Rank> begin(const bounds<Rank> &bnd) POUTRE_NOEXCEPT {
  return bnd.begin();
}

template <ptrdiff_t Rank>
bounds_iterator<Rank> end(const bounds<Rank> &bnd) POUTRE_NOEXCEPT {
  return bnd.end();
}

template <ptrdiff_t Rank>
bounds_iterator<Rank> cbegin(const bounds<Rank> &bnd) POUTRE_NOEXCEPT {
  return bnd.cbegin();
}

template <ptrdiff_t Rank>
bounds_iterator<Rank> cend(const bounds<Rank> &bnd) POUTRE_NOEXCEPT {
  return bnd.cend();
}
...
bool operator==(const bounds_iterator<Rank> &lhs,
                const bounds_iterator<Rank> &rhs) POUTRE_NOEXCEPT {
  return (lhs == rhs);
}
