...
namespace poutre
{
  ...
  std::ostream &operator<<(std::ostream &os, ImgType imgType)
  {
    switch( imgType )
    {
    case ImgType::ImgType_Dense: os << "Dense"; break;
    case ImgType::ImgType_Sparse: os << "Sparse"; break;
  ...
  std::ostream &operator<<(std::ostream &os, PType p)
  {
    ...
    case PType::PType_GrayUINT8: os << "GUINT8"; break;
    case PType::PType_GrayINT32: os << "GINT32"; break;
    case PType::PType_GrayINT64: os << "GINT64"; break;
    case PType::PType_F32: os << "F32"; break;
    case PType::PType_D64: os << "D64"; break;
