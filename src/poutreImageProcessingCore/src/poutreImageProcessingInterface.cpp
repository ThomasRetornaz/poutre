...
namespace poutre
{
    ...
    std::unique_ptr<IInterface> CreateDenseDispatchPTypeScalar(const std::vector<std::size_t> &dims, PType ptype)
    {
        ...
        default: {
            POUTRE_RUNTIME_ERROR(("CreateDenseDispatchPTypeScalar:: Unsupported scalar type:" +
    ...
    template <size_t numDims>
    std::unique_ptr<IInterface> CreateDenseDispatchDims(const std::vector<std::size_t> &dims, CompoundType ctype,
                                                        PType ptype)
    {
        switch (ctype)
        {
    ...
    std::unique_ptr<IInterface> CreateImage1DDispatchPTypeScalar(const std::vector<std::size_t> &dims, PType ptype)
    {
        ...
        default: {
            POUTRE_RUNTIME_ERROR(("CreateImage1DDispatchPTypeScalar:: Unsupported scalar type:" +
                                  boost::lexical_cast<std::string>(ptype)));
            return std::unique_ptr<IInterface>();
        }
        }
    ...
    template <size_t numDims>
    std::unique_ptr<IInterface> CreateImage1DDispatch(const std::vector<std::size_t> &dims, CompoundType ctype,
                                                      PType ptype)
    {
        switch (ctype)
        {
    ...
    std::unique_ptr<IInterface> CreateImage2DDispatchPTypeScalar(const std::vector<std::size_t> &dims, PType ptype)
    {
        ...
        default: {
            POUTRE_RUNTIME_ERROR(("CreateImage2DDispatchPTypeScalar:: Unsupported scalar type:" +
                                  boost::lexical_cast<std::string>(ptype)));
            return std::unique_ptr<IInterface>();
        }
        }
    ...
    template <size_t numDims>
    std::unique_ptr<IInterface> CreateImage2DDispatch(const std::vector<std::size_t> &dims, CompoundType ctype,
                                                      PType ptype)
    {
        switch (ctype)
        {
    ...
    std::unique_ptr<IInterface> CreateImage3DDispatchPTypeScalar(const std::vector<std::size_t> &dims, PType ptype)
    {
        ...
        default: {
            POUTRE_RUNTIME_ERROR(("CreateImage3DDispatchPTypeScalar:: Unsupported scalar type:" +
                                  boost::lexical_cast<std::string>(ptype)));
            return std::unique_ptr<IInterface>();
        }
        }
    ...
    template <size_t numDims>
    std::unique_ptr<IInterface> CreateImage3DDispatch(const std::vector<std::size_t> &dims, CompoundType ctype,
                                                      PType ptype)
    {
        switch (ctype)
        {
