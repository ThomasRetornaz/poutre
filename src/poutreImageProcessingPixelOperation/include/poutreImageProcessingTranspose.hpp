...
* @warning 
*/
#define tblock16x16(tmp1,r0,r1,r2,r3,r4,r5,r6,r7,r8,	\
   ...
   struct t_transposeOp<pUINT8, pUINT8>
   {
      ...
      void operator()(const DenseImage<pUINT8,2>& i_vin1, DenseImage<pUINT8,2>& o_vout) const
      {
         ...
         for (y = 0; y < ySizeSimdLoop; y += loopStep)
         {
            ...
            {
               r0 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+0)*xsize+x));
               r1 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+1)*xsize+x));
               r2 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+2)*xsize+x));
               r3 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+3)*xsize+x));
               r4 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+4)*xsize+x));
               r5 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+5)*xsize+x));
               r6 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+6)*xsize+x));
               r7 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+7)*xsize+x));
               r8 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+8)*xsize+x));
               r9 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+9)*xsize+x));
               r10 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+10)*xsize+x));
               r11 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+11)*xsize+x));
               r12 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+12)*xsize+x));
               r13 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+13)*xsize+x));
               r14 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+14)*xsize+x));
               r15 = _mm_loadu_si128((__m128i const*)(i_vinbeg1+(y+15)*xsize+x));
               // p128_hex_u8(r0);
               // p128_hex_u8(r1);
               ...
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 0)*oxsize + y), r15);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 1)*oxsize + y), r7);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 2)*oxsize + y), r11);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 3)*oxsize + y), r3);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 4)*oxsize + y), r13); //-V112
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 5)*oxsize + y), r5);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 6)*oxsize + y), r9);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 7)*oxsize + y), r1);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 8)*oxsize + y), r14);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 9)*oxsize + y), r6);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 10)*oxsize + y), r10);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 11)*oxsize + y), r2);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 12)*oxsize + y), r12);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 13)*oxsize + y), r4);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 14)*oxsize + y), r8);
               _mm_storeu_si128((__m128i *)(o_voutbeg+(x + 15)*oxsize + y), r0);
            }
         }
         //epilogue
         /*for(scoord y=0;y<xsize;y++)
         ...
         */
         ...
         for (y = 0; y < ySizeSimdLoop; y++)
         {
            ...
            {
               o_voutbeg[oxsize*y+x] =i_vinbeg1[xsize*x+y];//o_voutbeg[x*oxsize + y] = i_vinbeg1[x + y * xsize];
            }
         }
         for (y = ySizeSimdLoop; y < ysize; y++)
         {
...
//                r0 = _mm256_insertf128_ps(_mm256_castps128_ps256(_mm_loadu_ps(i_vin1[y + 0].data() + x + 0)), _mm_loadu_ps(i_vin1[y + 4].data() + x + 0), 1); //-V112
//                r1 = _mm256_insertf128_ps(_mm256_castps128_ps256(_mm_loadu_ps(i_vin1[y + 1].data() + x + 0)), _mm_loadu_ps(i_vin1[y + 5].data() + x + 0), 1);
//                r2 = _mm256_insertf128_ps(_mm256_castps128_ps256(_mm_loadu_ps(i_vin1[y + 2].data() + x + 0)), _mm_loadu_ps(i_vin1[y + 6].data() + x + 0), 1);
//                r3 = _mm256_insertf128_ps(_mm256_castps128_ps256(_mm_loadu_ps(i_vin1[y + 3].data() + x + 0)), _mm_loadu_ps(i_vin1[y + 7].data() + x + 0), 1);
//                r4 = _mm256_insertf128_ps(_mm256_castps128_ps256(_mm_loadu_ps(i_vin1[y + 0].data() + x + 4)), _mm_loadu_ps(i_vin1[y + 4].data() + x + 4), 1); //-V112
//                r5 = _mm256_insertf128_ps(_mm256_castps128_ps256(_mm_loadu_ps(i_vin1[y + 1].data() + x + 4)), _mm_loadu_ps(i_vin1[y + 5].data() + x + 4), 1); //-V112
//                r6 = _mm256_insertf128_ps(_mm256_castps128_ps256(_mm_loadu_ps(i_vin1[y + 2].data() + x + 4)), _mm_loadu_ps(i_vin1[y + 6].data() + x + 4), 1); //-V112
//                r7 = _mm256_insertf128_ps(_mm256_castps128_ps256(_mm_loadu_ps(i_vin1[y + 3].data() + x + 4)), _mm_loadu_ps(i_vin1[y + 7].data() + x + 4), 1); //-V112
