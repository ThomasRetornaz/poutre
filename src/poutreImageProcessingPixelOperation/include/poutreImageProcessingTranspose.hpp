...
template <typename T1, typename Tout> struct t_transposeOp<T1, Tout> {
  ...
  void operator()(const DenseImage<T1, 2> &i_vin1,
                  DenseImage<Tout, 2> &o_vout) const {
...
* @warning
*/
#define tblock16x16(tmp1, r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11,    \
                    r12, r13, r14, r15)                                        \
...
template <> struct t_transposeOp<pUINT8, pUINT8> {
  ...
  void operator()(const DenseImage<pUINT8, 2> &i_vin1,
                  DenseImage<pUINT8, 2> &o_vout) const {
    ...
    __m128i tmp1, r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13,
        r14, r15;
    for (y = 0; y < ySizeSimdLoop; y += loopStep) {
      for (x = 0; x < xSizeSimdLoop; x += loopStep) {
        r0 =
            _mm_loadu_si128((__m128i const *)(i_vinbeg1 + (y + 0) * xstep + x));
        r1 =
            _mm_loadu_si128((__m128i const *)(i_vinbeg1 + (y + 1) * xstep + x));
        r2 =
            _mm_loadu_si128((__m128i const *)(i_vinbeg1 + (y + 2) * xstep + x));
        r3 =
        ...
        r6 =
            _mm_loadu_si128((__m128i const *)(i_vinbeg1 + (y + 6) * xstep + x));
        r7 =
            _mm_loadu_si128((__m128i const *)(i_vinbeg1 + (y + 7) * xstep + x));
        r8 =
            _mm_loadu_si128((__m128i const *)(i_vinbeg1 + (y + 8) * xstep + x));
        r9 =
            _mm_loadu_si128((__m128i const *)(i_vinbeg1 + (y + 9) * xstep + x));
        r10 = _mm_loadu_si128(
            (__m128i const *)(i_vinbeg1 + (y + 10) * xstep + x));
        r11 = _mm_loadu_si128(
            (__m128i const *)(i_vinbeg1 + (y + 11) * xstep + x));
        r12 = _mm_loadu_si128(
            (__m128i const *)(i_vinbeg1 + (y + 12) * xstep + x));
        r13 = _mm_loadu_si128(
            (__m128i const *)(i_vinbeg1 + (y + 13) * xstep + x));
        r14 = _mm_loadu_si128(
            (__m128i const *)(i_vinbeg1 + (y + 14) * xstep + x));
        r15 = _mm_loadu_si128(
            (__m128i const *)(i_vinbeg1 + (y + 15) * xstep + x));
        // p128_hex_u8(r0);
        // p128_hex_u8(r1);

        tblock16x16(tmp1, r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12,
                    r13, r14, r15);
