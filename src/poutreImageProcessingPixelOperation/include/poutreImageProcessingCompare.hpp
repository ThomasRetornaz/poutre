...
template <typename T1> struct OpCompEqualValue {
  ...
  template <typename U>
  POUTRE_ALWAYS_INLINE simd_mask_t
  operator()(const U &lhs) const POUTRE_NOEXCEPT {
...
template <typename Tin, typename Tout, class CompareOp> struct compare_sss {
  ...
  compare_sss(const Tout &i_valtrue, const Tout &i_valfalse)
      : cop(), m_valtrue(i_valtrue), m_valfalse(i_valfalse) {}
  compare_sss(const Tout &i_valtrue, const Tout &i_valfalse,
              const CompareOp &op)
...
struct compare_sss_simd {
  ...
  compare_sss_simd(const Tout &i_valtrue, const Tout &i_valfalse)
      : cop(), m_valtrue_pack(i_valtrue), m_valfalse_pack(i_valfalse),
        m_valtrue(i_valtrue), m_valfalse(i_valfalse) {}
  compare_sss_simd(const Tout &i_valtrue, const Tout &i_valfalse,
                   const CompareOp &op)
      : cop(op), m_valtrue_pack(i_valtrue), m_valfalse_pack(i_valfalse),
        m_valtrue(i_valtrue), m_valfalse(i_valfalse) {}
...
template <typename Tin, typename Tout, ptrdiff_t Rank,
          template <typename, ptrdiff_t> class ViewIn, class Op,
          template <typename, ptrdiff_t> class ViewOut>
struct viewCompare_sss {

  void operator()(const ViewIn<Tin, Rank> &i_vin, Op i_op,
...
struct viewCompare_sss_simd {
  void operator()(const array_view<Tin, Rank> &i_vin, Op i_op,
                  typename boost::call_traits<Tout>::param_type i_valtrue,
                  typename boost::call_traits<Tout>::param_type i_valfalse,
                  array_view<Tout, Rank> &o_vout) {

    static_assert(std::is_same<std::remove_const_t<Tin>,
                               std::remove_const_t<Tout>>::value,
                  "should be same type");
    /*std::cout <<
    "***********************************************************************************"
...
template <typename Tin, typename Tout, ptrdiff_t Rank,
          ...
          template <typename, ptrdiff_t> class ViewOut, typename = void>
struct ViewCompare_sss_dispatch {
  void operator()(const ViewIn<Tin, Rank> &i_vin, CompOpType compOpType,
    ...
    case CompOpType::CompOpEqual: {
      ...
      return viewCompare_sss<Tin, Tout, Rank, ViewIn, OpCompEqualValue<Tin>,
                             ViewOut>()(i_vin, myop, i_valtrue, i_valfalse,
                                        o_vout);
    } break;
    case CompOpType::CompOpDiff: {
      OpCompDiffValue<Tin> myop(i_compval);
      return viewCompare_sss<Tin, Tout, Rank, ViewIn, OpCompDiffValue<Tin>,
                             ViewOut>()(i_vin, myop, i_valtrue, i_valfalse,
                                        o_vout);
    } break;
    case CompOpType::CompOpSup: {
      OpCompSupValue<Tin> myop(i_compval);
      return viewCompare_sss<Tin, Tout, Rank, ViewIn, OpCompSupValue<Tin>,
                             ViewOut>()(i_vin, myop, i_valtrue, i_valfalse,
                                        o_vout);
    } break;
    case CompOpType::CompOpSupEqual: {
      OpCompSupEqualValue<Tin> myop(i_compval);
      return viewCompare_sss<Tin, Tout, Rank, ViewIn, OpCompSupEqualValue<Tin>,
                             ViewOut>()(i_vin, myop, i_valtrue, i_valfalse,
                                        o_vout);
    } break;
    case CompOpType::CompOpInf: {
      OpCompInfValue<Tin> myop(i_compval);
      return viewCompare_sss<Tin, Tout, Rank, ViewIn, OpCompInfValue<Tin>,
                             ViewOut>()(i_vin, myop, i_valtrue, i_valfalse,
                                        o_vout);
    } break;
    case CompOpType::CompOpInfEqual: {
      OpCompInfEqualValue<Tin> myop(i_compval);
      return viewCompare_sss<Tin, Tout, Rank, ViewIn, OpCompInfEqualValue<Tin>,
                             ViewOut>()(i_vin, myop, i_valtrue, i_valfalse,
                                        o_vout);
    } break;
    default: {
      POUTRE_RUNTIME_ERROR(
          "ViewCompare_sss_dispatch CompOpType not implemented");
    }
    }
  }
};
...
template <typename Tin, typename Tout, ptrdiff_t Rank>
struct ViewCompare_sss_dispatch<
    Tin, Tout, Rank, array_view, array_view,
    std::enable_if_t<std::is_same<std::remove_const_t<Tin>,
                                  std::remove_const_t<Tout>>::value &&
                     std::is_arithmetic<Tin>::value>> {

  void operator()(const array_view<Tin, Rank> &i_vin, CompOpType compOpType,
                  typename boost::call_traits<Tin>::param_type i_compval,
                  typename boost::call_traits<Tout>::param_type i_valtrue,
                  typename boost::call_traits<Tout>::param_type i_valfalse,
                  array_view<Tout, Rank> &o_vout)

  {
    ...
    case CompOpType::CompOpEqual: {
      OpCompEqualValue<Tin> myop(i_compval);
      return viewCompare_sss_simd<Tin, Tout, Rank, OpCompEqualValue<Tin>>()(
          i_vin, myop, i_valtrue, i_valfalse, o_vout);
    } break;
    case CompOpType::CompOpDiff: {
      OpCompDiffValue<Tin> myop(i_compval);
      return viewCompare_sss_simd<Tin, Tout, Rank, OpCompDiffValue<Tin>>()(
          i_vin, myop, i_valtrue, i_valfalse, o_vout);
    } break;

    case CompOpType::CompOpSup: {
      OpCompSupValue<Tin> myop(i_compval);
      return viewCompare_sss_simd<Tin, Tout, Rank, OpCompSupValue<Tin>>()(
          i_vin, myop, i_valtrue, i_valfalse, o_vout);
    } break;
    case CompOpType::CompOpSupEqual: {
      OpCompSupEqualValue<Tin> myop(i_compval);
      return viewCompare_sss_simd<Tin, Tout, Rank, OpCompSupEqualValue<Tin>>()(
          i_vin, myop, i_valtrue, i_valfalse, o_vout);
    } break;
    case CompOpType::CompOpInf: {
      OpCompInfValue<Tin> myop(i_compval);
      return viewCompare_sss_simd<Tin, Tout, Rank, OpCompInfValue<Tin>>()(
          i_vin, myop, i_valtrue, i_valfalse, o_vout);
    } break;
    case CompOpType::CompOpInfEqual: {
      OpCompInfEqualValue<Tin> myop(i_compval);
      return viewCompare_sss_simd<Tin, Tout, Rank, OpCompInfEqualValue<Tin>>()(
          i_vin, myop, i_valtrue, i_valfalse, o_vout);
    } break;
    default: {
      POUTRE_RUNTIME_ERROR(
...
void ViewCompare_sss_func_helper(
    const ViewIn<Tin, Rank> &i_vin, CompOpType compOpType,
    typename boost::call_traits<Tin>::param_type i_compval,
    typename boost::call_traits<Tout>::param_type i_valtrue,
    typename boost::call_traits<Tout>::param_type i_valfalse,
    ViewOut<Tout, Rank> &o_vout) {
...
/*                                                      III */
/*************************************************************************************************************************************/
template <typename Tin, typename TComp, typename Ttrue, typename Tfalse,
          typename Tout, class CompareOp>
struct compare_iii {
  const CompareOp cop;
  ...
  POUTRE_ALWAYS_INLINE Tout
  operator()(param_typein i_val, param_typecomp i_comp, param_typetrue i_true,
...
template <typename Tin, typename Tcomp, typename Ttrue, typename Tfalse,
          typename Tout, ptrdiff_t Rank,
          template <typename, ptrdiff_t> class ViewIn,
          template <typename, ptrdiff_t> class ViewComp,
          template <typename, ptrdiff_t> class ViewTrue,
          template <typename, ptrdiff_t> class ViewFalse, class Op,
          template <typename, ptrdiff_t> class ViewOut>
void t_ViewCompare_iii(const ViewIn<Tin, Rank> &i_vin, Op i_op,
...
void ViewCompare_iii_dispatch(const ViewIn<Tin, Rank> &i_vin,
  ...
  switch (compOpType) {
  case CompOpType::CompOpEqual: {
    return t_ViewCompare_iii(i_vin, std::equal_to<Tin>(), i_vcomp, i_vtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpDiff: {
    return t_ViewCompare_iii(i_vin, std::not_equal_to<Tin>(), i_vcomp, i_vtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpSup: {
    return t_ViewCompare_iii(i_vin, std::greater<Tin>(), i_vcomp, i_vtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpSupEqual: {
    return t_ViewCompare_iii(i_vin, std::greater_equal<Tin>(), i_vcomp, i_vtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpInf: {
    return t_ViewCompare_iii(i_vin, std::less<Tin>(), i_vcomp, i_vtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpInfEqual: {
    return t_ViewCompare_iii(i_vin, std::less_equal<Tin>(), i_vcomp, i_vtrue,
                             i_vfalse, o_vout);
  } break;
  default: {
...
void ViewCompare_iii_func_helper(const ViewIn<Tin, Rank> &i_vin,
                                 ...
                                 const ViewFalse<Tfalse, Rank> &i_vfalse,
                                 ViewOut<Tout, Rank> &o_vout) {
  return ViewCompare_iii_dispatch(i_vin, compOpType, i_vcomp, i_vtrue, i_vfalse,
                                  o_vout);
}
/*************************************************************************************************************************************/
/*                                                      SII */
/*************************************************************************************************************************************/
template <typename Tin, typename Ttrue, typename Tfalse, typename Tout,
          class CompareOp>
struct compare_sii {
  const CompareOp cop;
  const Tin m_compval;
  ...
  compare_sii(const Tin &i_compval, const CompareOp &op)
      : cop(op), m_compval(i_compval) {}
  POUTRE_ALWAYS_INLINE Tout
  operator()(param_typein i_val, param_typetrue i_true,
...
template <typename Tin, typename Ttrue, typename Tfalse, typename Tout,
          ptrdiff_t Rank, template <typename, ptrdiff_t> class ViewIn,
          template <typename, ptrdiff_t> class ViewTrue,
          template <typename, ptrdiff_t> class ViewFalse, class Op,
          template <typename, ptrdiff_t> class ViewOut>
void t_ViewCompare_sii(const ViewIn<Tin, Rank> &i_vin, Op i_op,
                       typename boost::call_traits<Tin>::param_type i_compval,
                       const ViewTrue<Ttrue, Rank> &i_vtrue,
                       const ViewFalse<Tfalse, Rank> &i_vfalse,
                       ViewOut<Tout, Rank> &o_vout) {
...
void ViewCompare_sii_dispatch(
    ...
    typename boost::call_traits<Tin>::param_type i_compval,
    const ViewTrue<Ttrue, Rank> &i_vtrue,
    const ViewFalse<Tfalse, Rank> &i_vfalse, ViewOut<Tout, Rank> &o_vout) {
  static_assert(std::is_convertible<Ttrue, Tout>(),
  ...
  switch (compOpType) {
  case CompOpType::CompOpEqual: {
    return t_ViewCompare_sii(i_vin, std::equal_to<Tin>(), i_compval, i_vtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpDiff: {
    return t_ViewCompare_sii(i_vin, std::not_equal_to<Tin>(), i_compval,
                             i_vtrue, i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpSup: {
    return t_ViewCompare_sii(i_vin, std::greater<Tin>(), i_compval, i_vtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpSupEqual: {
    return t_ViewCompare_sii(i_vin, std::greater_equal<Tin>(), i_compval,
                             i_vtrue, i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpInf: {
    return t_ViewCompare_sii(i_vin, std::less<Tin>(), i_compval, i_vtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpInfEqual: {
    return t_ViewCompare_sii(i_vin, std::less_equal<Tin>(), i_compval, i_vtrue,
                             i_vfalse, o_vout);
  } break;
  default: {
...
template <typename Tin, typename Ttrue, typename Tfalse, typename Tout,
          ...
          template <typename, ptrdiff_t> class ViewFalse,
          template <typename, ptrdiff_t> class ViewOut>
void ViewCompare_sii_func_helper(
    const ViewIn<Tin, Rank> &i_vin, CompOpType compOpType,
    typename boost::call_traits<Tin>::param_type i_compval,
    const ViewTrue<Ttrue, Rank> &i_vtrue,
    const ViewFalse<Tfalse, Rank> &i_vfalse, ViewOut<Tout, Rank> &o_vout) {
  return ViewCompare_sii_dispatch(i_vin, compOpType, i_compval, i_vtrue,
                                  i_vfalse, o_vout);
}
...
struct compare_sis {
  ...
  using param_typein = typename boost::call_traits<Tin>::param_type;
  using param_typetrue = typename boost::call_traits<Ttrue>::param_type;
  compare_sis(const Tin &i_compval, const Tout &i_valfalse)
      : cop(), m_compval(i_compval), m_valfalse(i_valfalse) {}
  compare_sis(const Tin &i_compval, const Tout &i_valfalse, const CompareOp &op)
      : cop(op), m_compval(i_compval), m_valfalse(i_valfalse) {}
  POUTRE_ALWAYS_INLINE Tout
  operator()(param_typein i_val,
...
template <typename Tin, typename Ttrue, typename Tout, ptrdiff_t Rank,
          template <typename, ptrdiff_t> class ViewIn,
          template <typename, ptrdiff_t> class ViewTrue, class Op,
          template <typename, ptrdiff_t> class ViewOut>
void t_ViewCompare_sis(const ViewIn<Tin, Rank> &i_vin, Op i_op,
                       typename boost::call_traits<Tin>::param_type i_compval,
                       const ViewTrue<Ttrue, Rank> &i_vtrue,
                       typename boost::call_traits<Tout>::param_type i_valfalse,
                       ViewOut<Tout, Rank> &o_vout) {
...
void ViewCompare_sis_dispatch(
  ...
  switch (compOpType) {
  case CompOpType::CompOpEqual: {
    return t_ViewCompare_sis(i_vin, std::equal_to<Tin>(), i_compval, i_vtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpDiff: {
    return t_ViewCompare_sis(i_vin, std::not_equal_to<Tin>(), i_compval,
                             i_vtrue, i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpSup: {
    return t_ViewCompare_sis(i_vin, std::greater<Tin>(), i_compval, i_vtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpSupEqual: {
    return t_ViewCompare_sis(i_vin, std::greater_equal<Tin>(), i_compval,
                             i_vtrue, i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpInf: {
    return t_ViewCompare_sis(i_vin, std::less<Tin>(), i_compval, i_vtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpInfEqual: {
    return t_ViewCompare_sis(i_vin, std::less_equal<Tin>(), i_compval, i_vtrue,
                             i_valfalse, o_vout);
  } break;
  default: {
    POUTRE_RUNTIME_ERROR("ViewCompare_sis_dispatch CompOpType not implemented");
...
template <typename Tin, typename Ttrue, typename Tout, ptrdiff_t Rank,
          ...
          template <typename, ptrdiff_t> class ViewTrue,
          template <typename, ptrdiff_t> class ViewOut>
void ViewCompare_sis_func_helper(
    const ViewIn<Tin, Rank> &i_vin, CompOpType compOpType,
    typename boost::call_traits<Tin>::param_type i_compval,
    const ViewTrue<Ttrue, Rank> &i_vtrue,
    typename boost::call_traits<Tout>::param_type i_valfalse,
    ViewOut<Tout, Rank> &o_vout) {
  return ViewCompare_sis_dispatch(i_vin, compOpType, i_compval, i_vtrue,
                                  i_valfalse, o_vout);
}
/*************************************************************************************************************************************/
/*                                                      ISI */
/*************************************************************************************************************************************/
template <typename Tin, typename Tcomp, typename Tfalse, typename Tout,
          class CompareOp>
struct compare_isi {
  const CompareOp cop;
  ...
  compare_isi(const Tout &i_valtrue, const CompareOp &op)
      : cop(op), m_valtrue(i_valtrue) {}
  POUTRE_ALWAYS_INLINE Tout
  operator()(param_typein i_val, param_typecomp i_comp,
             param_typefalse i_false) const POUTRE_NOEXCEPT // TODO inline ?
  {
...
template <typename Tin, typename Tcomp, typename Tfalse, typename Tout,
          ...
          template <typename, ptrdiff_t> class ViewFalse, class Op,
          template <typename, ptrdiff_t> class ViewOut>
void t_ViewCompare_isi(const ViewIn<Tin, Rank> &i_vin, Op i_op,
                       const ViewComp<Tcomp, Rank> &i_vcomp,
                       typename boost::call_traits<Tout>::param_type i_valtrue,
                       const ViewFalse<Tfalse, Rank> &i_vfalse,
                       ViewOut<Tout, Rank> &o_vout) {
...
void ViewCompare_isi_dispatch(
    ...
    const ViewComp<Tcomp, Rank> &i_vcomp,
    typename boost::call_traits<Tout>::param_type i_valtrue,
    const ViewTrue<Tfalse, Rank> &i_vfalse, ViewOut<Tout, Rank> &o_vout) {
  static_assert(std::is_convertible<Tfalse, Tout>(),
  ...
  switch (compOpType) {
  case CompOpType::CompOpEqual: {
    return t_ViewCompare_isi(i_vin, std::equal_to<Tin>(), i_vcomp, i_valtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpDiff: {
    return t_ViewCompare_isi(i_vin, std::not_equal_to<Tin>(), i_vcomp,
                             i_valtrue, i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpSup: {
    return t_ViewCompare_isi(i_vin, std::greater<Tin>(), i_vcomp, i_valtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpSupEqual: {
    return t_ViewCompare_isi(i_vin, std::greater_equal<Tin>(), i_vcomp,
                             i_valtrue, i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpInf: {
    return t_ViewCompare_isi(i_vin, std::less<Tin>(), i_vcomp, i_valtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpInfEqual: {
    return t_ViewCompare_isi(i_vin, std::less_equal<Tin>(), i_vcomp, i_valtrue,
                             i_vfalse, o_vout);
  } break;
  default: {
...
template <typename Tin, typename Tcomp, typename Tfalse, typename Tout,
          ...
          template <typename, ptrdiff_t> class ViewTrue,
          template <typename, ptrdiff_t> class ViewOut>
void ViewCompare_isi_func_helper(
    const ViewIn<Tin, Rank> &i_vin, CompOpType compOpType,
    const ViewComp<Tcomp, Rank> &i_vcomp,
    typename boost::call_traits<Tout>::param_type i_valtrue,
    const ViewTrue<Tfalse, Rank> &i_vfalse, ViewOut<Tout, Rank> &o_vout) {
  return ViewCompare_isi_dispatch(i_vin, compOpType, i_vcomp, i_valtrue,
                                  i_vfalse, o_vout);
}
/*************************************************************************************************************************************/
/*                                                      IIS */
/*************************************************************************************************************************************/
template <typename Tin, typename Tcomp, typename Ttrue, typename Tout,
          class CompareOp>
struct compare_iis {
  const CompareOp cop;
  const Tout m_valfalse;
  ...
  compare_iis(const Tout &i_valfalse, const CompareOp &op)
      : cop(op), m_valfalse(i_valfalse) {}
  POUTRE_ALWAYS_INLINE Tout
  operator()(param_typein i_val, param_typecomp i_comp,
             param_typetrue i_true) const POUTRE_NOEXCEPT // TODO inline ?
  {
...
template <typename Tin, typename Tcomp, typename Ttrue, typename Tout,
          ...
          template <typename, ptrdiff_t> class ViewTrue, class Op,
          template <typename, ptrdiff_t> class ViewOut>
void t_ViewCompare_iis(const ViewIn<Tin, Rank> &i_vin, Op i_op,
                       const ViewComp<Tcomp, Rank> &i_vcomp,
                       const ViewTrue<Ttrue, Rank> &i_vtrue,
                       typename boost::call_traits<Tout>::param_type i_valfalse,
                       ViewOut<Tout, Rank> &o_vout) {
...
void ViewCompare_iis_dispatch(
    const ViewIn<Tin, Rank> &i_vin, CompOpType compOpType,
    const ViewComp<Tcomp, Rank> &i_vcomp, const ViewTrue<Ttrue, Rank> &i_vtrue,
    typename boost::call_traits<Tout>::param_type i_valfalse,
    ViewOut<Tout, Rank> &o_vout) {
  static_assert(std::is_convertible<Ttrue, Tout>(),
  ...
  switch (compOpType) {
  case CompOpType::CompOpEqual: {
    return t_ViewCompare_iis(i_vin, std::equal_to<Tin>(), i_vcomp, i_vtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpDiff: {
    return t_ViewCompare_iis(i_vin, std::not_equal_to<Tin>(), i_vcomp, i_vtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpSup: {
    return t_ViewCompare_iis(i_vin, std::greater<Tin>(), i_vcomp, i_vtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpSupEqual: {
    return t_ViewCompare_iis(i_vin, std::greater_equal<Tin>(), i_vcomp, i_vtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpInf: {
    return t_ViewCompare_iis(i_vin, std::less<Tin>(), i_vcomp, i_vtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpInfEqual: {
    return t_ViewCompare_iis(i_vin, std::less_equal<Tin>(), i_vcomp, i_vtrue,
                             i_valfalse, o_vout);
  } break;
  default: {
...
template <typename Tin, typename Tcomp, typename Ttrue, typename Tout,
          ...
          template <typename, ptrdiff_t> class ViewTrue,
          template <typename, ptrdiff_t> class ViewOut>
void ViewCompare_iis_func_helper(
    const ViewIn<Tin, Rank> &i_vin, CompOpType compOpType,
    const ViewComp<Tcomp, Rank> &i_vcomp, const ViewTrue<Ttrue, Rank> &i_vtrue,
    typename boost::call_traits<Tout>::param_type i_valfalse,
    ViewOut<Tout, Rank> &o_vout) {
  return ViewCompare_iis_dispatch(i_vin, compOpType, i_vcomp, i_vtrue,
                                  i_valfalse, o_vout);
}
...
struct compare_ssi {
  ...
  compare_ssi(const Tin &i_compval, const Tout &i_valtrue)
      : cop(), m_compval(i_compval), m_valtrue(i_valtrue) {}
  compare_ssi(const Tin &i_compval, const Tout &i_valtrue, const CompareOp &op)
      : cop(op), m_compval(i_compval), m_valtrue(i_valtrue) {}
  POUTRE_ALWAYS_INLINE Tout
  operator()(param_typein i_val,
             param_typetrue i_false) const POUTRE_NOEXCEPT // TODO inline ?
  {
...
template <typename Tin, typename Tfalse, typename Tout, ptrdiff_t Rank,
          ...
          template <typename, ptrdiff_t> class ViewFalse, class Op,
          template <typename, ptrdiff_t> class ViewOut>
void t_ViewCompare_ssi(const ViewIn<Tin, Rank> &i_vin, Op i_op,
                       typename boost::call_traits<Tin>::param_type i_compval,
                       typename boost::call_traits<Tout>::param_type i_valtrue,
                       const ViewFalse<Tfalse, Rank> &i_vfalse,
                       ViewOut<Tout, Rank> &o_vout) {
...
void ViewCompare_ssi_dispatch(
  ...
  switch (compOpType) {
  case CompOpType::CompOpEqual: {
    return t_ViewCompare_ssi(i_vin, std::equal_to<Tin>(), i_compval, i_valtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpDiff: {
    return t_ViewCompare_ssi(i_vin, std::not_equal_to<Tin>(), i_compval,
                             i_valtrue, i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpSup: {
    return t_ViewCompare_ssi(i_vin, std::greater<Tin>(), i_compval, i_valtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpSupEqual: {
    return t_ViewCompare_ssi(i_vin, std::greater_equal<Tin>(), i_compval,
                             i_valtrue, i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpInf: {
    return t_ViewCompare_ssi(i_vin, std::less<Tin>(), i_compval, i_valtrue,
                             i_vfalse, o_vout);
  } break;
  case CompOpType::CompOpInfEqual: {
    return t_ViewCompare_ssi(i_vin, std::less_equal<Tin>(), i_compval,
                             i_valtrue, i_vfalse, o_vout);
  } break;
  default: {
...
template <typename Tin, typename Tfalse, typename Tout, ptrdiff_t Rank,
          ...
          template <typename, ptrdiff_t> class ViewFalse,
          template <typename, ptrdiff_t> class ViewOut>
void ViewCompare_ssi_func_helper(
    const ViewIn<Tin, Rank> &i_vin, CompOpType compOpType,
    typename boost::call_traits<Tin>::param_type i_compval,
    typename boost::call_traits<Tout>::param_type i_valtrue,
    const ViewFalse<Tfalse, Rank> &i_vfalse, ViewOut<Tout, Rank> &o_vout) {
  return ViewCompare_ssi_dispatch(i_vin, compOpType, i_compval, i_valtrue,
                                  i_vfalse, o_vout);
}
/*************************************************************************************************************************************/
/*                                                      ISS */
...
struct compare_iss {
  ...
  compare_iss(const Tout &i_valtrue, const Tout &i_valfalse,
      ...
      : cop(op), m_valtrue(i_valtrue), m_valfalse(i_valfalse) {}
  POUTRE_ALWAYS_INLINE Tout
  operator()(param_type1 i_val1, param_type2 i_val2) const POUTRE_NOEXCEPT {
    return (cop(i_val1, i_val2) ? m_valtrue : m_valfalse);
  }
};

template <typename Tin1, typename Tin2, typename Tout, ptrdiff_t Rank,
          template <typename, ptrdiff_t> class ViewIn1,
          template <typename, ptrdiff_t> class ViewIn2, class Op,
          template <typename, ptrdiff_t> class ViewOut>
void t_ViewCompare_iss(const ViewIn1<Tin1, Rank> &i_vin1, Op i_op,
...
template <typename Tin1, typename Tin2, typename Tout, ptrdiff_t Rank,
          template <typename, ptrdiff_t> class ViewIn1,
          template <typename, ptrdiff_t> class ViewIn2,
          template <typename, ptrdiff_t> class ViewOut>
void ViewCompare_iss_dispatch(
    const ViewIn1<Tin1, Rank> &i_vin1, CompOpType compOpType,
    const ViewIn2<Tin2, Rank> &i_vin2,
    typename boost::call_traits<Tout>::param_type i_valtrue,
    typename boost::call_traits<Tout>::param_type i_valfalse,
    ViewOut<Tout, Rank> &o_vout) {
  ...
  switch (compOpType) {
  case CompOpType::CompOpEqual: {
    return t_ViewCompare_iss(i_vin1, std::equal_to<Tin1>(), i_vin2, i_valtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpDiff: {
    return t_ViewCompare_iss(i_vin1, std::not_equal_to<Tin1>(), i_vin2,
                             i_valtrue, i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpSup: {
    return t_ViewCompare_iss(i_vin1, std::greater<Tin1>(), i_vin2, i_valtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpSupEqual: {
    return t_ViewCompare_iss(i_vin1, std::greater_equal<Tin1>(), i_vin2,
                             i_valtrue, i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpInf: {
    return t_ViewCompare_iss(i_vin1, std::less<Tin1>(), i_vin2, i_valtrue,
                             i_valfalse, o_vout);
  } break;
  case CompOpType::CompOpInfEqual: {
    return t_ViewCompare_iss(i_vin1, std::less_equal<Tin1>(), i_vin2, i_valtrue,
                             i_valfalse, o_vout);
  } break;
  default: {
...
template <typename Tin1, typename Tin2, typename Tout, ptrdiff_t Rank,
          ...
          template <typename, ptrdiff_t> class ViewIn2,
          template <typename, ptrdiff_t> class ViewOut>
void ViewCompare_iss_func_helper(
    const ViewIn1<Tin1, Rank> &i_vin1, CompOpType compOpType,
    const ViewIn2<Tin2, Rank> &i_vin2,
    typename boost::call_traits<Tout>::param_type i_valtrue,
    typename boost::call_traits<Tout>::param_type i_valfalse,
    ViewOut<Tout, Rank> &o_vout) {
  return ViewCompare_iss_dispatch(i_vin1, compOpType, i_vin2, i_valtrue,
                                  i_valfalse, o_vout);
}
