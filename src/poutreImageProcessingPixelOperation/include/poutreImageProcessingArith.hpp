...
public:
  ...
  POUTRE_ALWAYS_INLINE T3 operator()(T1 const &a0,
                                     T2 const &a1) const POUTRE_NOEXCEPT {
...
public:
  ...
  POUTRE_ALWAYS_INLINE T operator()(T const &a0,
                                    T const &a1) const POUTRE_NOEXCEPT {
    accutype res = static_cast<accutype>(a0) - static_cast<accutype>(a1);
    if (res < static_cast<accutype>(m_minval))
      return m_minval;
...
void t_ArithSaturatedSub(const View1<T1, Rank> &i_vin1,
  ...
  PixelWiseBinaryOp<T1, T2, T3, Rank, View1, View2, View3, op_Saturated_Sub>(
...
void t_ArithSaturatedAdd(const View1<T1, Rank> &i_vin1,
                         const View2<T2, Rank> &i_vin2,
                         View3<T3, Rank> &o_vout) {
  PixelWiseBinaryOp<T1, T2, T3, Rank, View1, View2, View3, op_Saturated_Add>(
      i_vin1, i_vin2, o_vout);
}
...
public:
  op_Saturated_Add_Constant(T2 val)
      : m_val(val), m_maxval(TypeTraits<T2>::max()) {}
  POUTRE_ALWAYS_INLINE T2 operator()(T1 const &a0) const POUTRE_NOEXCEPT {
...
public:
  op_Saturated_Add_Constant(T val)
      : m_val(val), m_maxval(TypeTraits<T>::max()), m_simd_val(val) {}
  POUTRE_ALWAYS_INLINE T operator()(T const &a0) const POUTRE_NOEXCEPT {
    accutype res = static_cast<accutype>(m_val) + static_cast<accutype>(a0);
    if (res > static_cast<accutype>(m_maxval))
      return m_maxval;
...
void t_ArithSaturatedAddConstant(const View1<T1, Rank> &i_vin, T2 val,
                                 View2<T2, Rank> &o_vout) {
  PixelWiseUnaryOpWithValue<T1, T2, Rank, View1, View2,
...
public:
  op_Saturated_Sub_Constant(T2 val)
      : m_val(val), m_minval(TypeTraits<T2>::min()) {}
  POUTRE_ALWAYS_INLINE T2 operator()(T1 const &a0) const POUTRE_NOEXCEPT {
...
public:
  op_Saturated_Sub_Constant(T val)
      : m_val(val), m_minval(TypeTraits<T>::min()), m_simd_val(val) {}
...
template <typename T1, typename T2, ptrdiff_t Rank,
          ...
          template <typename, ptrdiff_t> class View2>
//@warning saturation is related to *View2 type*
void t_ArithSaturatedSubConstant(const View1<T1, Rank> &i_vin, T2 val,
                                 View2<T2, Rank> &o_vout) {
  PixelWiseUnaryOpWithValue<T1, T2, Rank, View1, View2,
...
template <typename T1, typename T2, typename T3, ptrdiff_t Rank,
          ...
          template <typename, ptrdiff_t> class View2,
          template <typename, ptrdiff_t> class View3>
void t_ArithSup(const View1<T1, Rank> &i_vin1, const View2<T2, Rank> &i_vin2,
                View3<T3, Rank> &o_vout) {
  PixelWiseBinaryOp<T1, T2, T3, Rank, View1, View2, View3, op_Sup>(
      i_vin1, i_vin2, o_vout);
}
...
// }
template <typename T1, typename T2, typename T3, ptrdiff_t Rank>
void t_ArithSup(const DenseImage<T1, Rank> &i_vin1,
                const DenseImage<T2, Rank> &i_vin2,
                DenseImage<T3, Rank> &o_vout) {
  auto viewIn1 = lview(const_cast<DenseImage<T1, Rank> &>(i_vin1));
...
template <typename T1, typename T2, typename T3, ptrdiff_t Rank,
          ...
          template <typename, ptrdiff_t> class View2,
          template <typename, ptrdiff_t> class View3>
void t_ArithInf(const View1<T1, Rank> &i_vin1, const View2<T2, Rank> &i_vin2,
                View3<T3, Rank> &o_vout) {
  PixelWiseBinaryOp<T1, T2, T3, Rank, View1, View2, View3, op_Inf>(
      i_vin1, i_vin2, o_vout);
}
...
// }
template <typename T1, typename T2, typename T3, ptrdiff_t Rank>
void t_ArithInf(const DenseImage<T1, Rank> &i_vin1,
                const DenseImage<T2, Rank> &i_vin2,
                DenseImage<T3, Rank> &o_vout) {
  auto viewIn1 = lview(const_cast<DenseImage<T1, Rank> &>(i_vin1));
  auto viewIn2 = lview(const_cast<DenseImage<T2, Rank> &>(i_vin2));
