...
namespace poutre
{
    ...
    template <typename T1, typename T2, typename T3, ptrdiff_t Rank, template <typename, ptrdiff_t> class View1,
    ...
    void t_ArithSaturatedSub(const DenseImage<T1, Rank> &i_vin1, const DenseImage<T2, Rank> &i_vin2,
    ...
    template <typename T1, typename T2, typename T3, ptrdiff_t Rank>
    void t_ArithSaturatedAdd(const DenseImage<T1, Rank> &i_vin1, const DenseImage<T2, Rank> &i_vin2,
                             DenseImage<T3, Rank> &o_vout)
    {
        auto viewIn1 = lview(const_cast<DenseImage<T1, Rank> &>(i_vin1));
        auto viewIn2 = lview(const_cast<DenseImage<T1, Rank> &>(i_vin2));
    ...
    // }
    template <typename T1, typename T2, typename T3, ptrdiff_t Rank>
    void t_ArithSup(const DenseImage<T1, Rank> &i_vin1, const DenseImage<T2, Rank> &i_vin2,
                    DenseImage<T3, Rank> &o_vout)
    {
        auto viewIn1 = lview(const_cast<DenseImage<T1, Rank> &>(i_vin1));
    ...
    // }
    template <typename T1, typename T2, typename T3, ptrdiff_t Rank>
    void t_ArithInf(const DenseImage<T1, Rank> &i_vin1, const DenseImage<T2, Rank> &i_vin2,
                    DenseImage<T3, Rank> &o_vout)
    {
        auto viewIn1 = lview(const_cast<DenseImage<T1, Rank> &>(i_vin1));
        auto viewIn2 = lview(const_cast<DenseImage<T2, Rank> &>(i_vin2));
