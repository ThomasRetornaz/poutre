...
namespace poutre
{
    ...
    template <typename T1, typename T2, typename T3, typename T4, typename Tout, ptrdiff_t Rank,
              template <typename, ptrdiff_t> class View1, template <typename, ptrdiff_t> class View2,
              template <typename, ptrdiff_t> class View3, template <typename, ptrdiff_t> class View4,
              template <typename, ptrdiff_t> class ViewOut, class QuaterOp>
    struct PixelWiseQuaternaryOpDispatcher
    {
        ...
        void operator()(const View1<T1, Rank> &i_vin1, const QuaterOp &op, const View2<T2, Rank> &i_vin2,
                        const View3<T3, Rank> &i_vin3, const View4<T4, Rank> &i_vin4, ViewOut<Tout, Rank> &o_vout) const
        {
    ...
    struct PixelWiseQuaternaryOpDispatcher<T1, T2, T3, T4, Tout, Rank, array_view, array_view, array_view, array_view,
                                           array_view, QuaterOp>
    {

        void operator()(const array_view<T1, Rank> &i_vin1, const QuaterOp &op, const array_view<T2, Rank> &i_vin2,
                        const array_view<T3, Rank> &i_vin3, const array_view<T4, Rank> &i_vin4,
    ...
    template <typename T1, typename T2, typename T3, typename T4, typename Tout, ptrdiff_t Rank,
              ...
              template <typename, ptrdiff_t> class View3, template <typename, ptrdiff_t> class View4,
              template <typename, ptrdiff_t> class ViewOut, class QuaterOp>
    void PixelWiseQuaternaryOp(const View1<T1, Rank> &i_vin1, const QuaterOp &op, const View2<T2, Rank> &i_vin2,
                               const View3<T3, Rank> &i_vin3, const View4<T4, Rank> &i_vin4,
                               ViewOut<Tout, Rank> &o_vout) POUTRE_NOEXCEPTONLYNDEBUG
    {
        ...
        PixelWiseQuaternaryOpDispatcher<T1, T2, T3, T4, Tout, Rank, View1, View2, View3, View4, ViewOut, QuaterOp>
            dispatcher;
